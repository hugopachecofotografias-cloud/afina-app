  ...
  return (
    <div className="team-menu-wrap">
      <button className="brand" onClick={() => setOpen(!open)}>
        <Music size={21} color="#E4B75B" /><span className="team-name-font">{team?.name || "Afiná"}</span><ChevronDown size={15} />
      </button>
      {open && (
...
const CSS = `
  ...
  * { box-sizing: border-box; font-family: 'Work Sans', sans-serif; }
  ...
  .team-name-font { font-family:'WestCoast','Fraunces',serif; font-size:1.3em; }
